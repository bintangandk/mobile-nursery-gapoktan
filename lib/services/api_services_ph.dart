...
class ApiServicePh {
  Future<PhData> fetchDailyPhSummary(String location) async {
    final url =
        'https://is4ac-nursery.research-ai.my.id/api/averagephtanah/$location'; // replace with your actual URL
